...
namespace Kütüphane_KayıtANDSilmeANDDüzenleme_
{
    public partial class Form1 : Form
    {
        ...
        {
            baglan.Open();
            SqlCommand komut = new SqlCommand("update kitaplar set id='"+ textBox1 .Text .ToString ()+ "',AdSoyad='" + textBox2.Text.ToString() + "',Kitap='" + textBox3.Text.ToString() + "',Yazar='" + textBox4.Text.ToString() + "',Sayfa='" + textBox5.Text.ToString() + "' where id ="+id+"",baglan );
            komut.ExecuteNonQuery();
            baglan.Close();
        }
    }
